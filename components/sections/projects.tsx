...
export function Projects() {
  ...
  // Scroll-based parallax (only background blobs)
  ...
  if (loading) {
    return (
      <section ref={containerRef} className="py-20 text-center">
    ...
    <section ref={containerRef} className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 overflow-y-hidden">
        ...
        <div className="hidden lg:block relative overflow-y-hidden">
          <button
            onClick={scrollLeft}
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 p-3 rounded-full glass hover:scale-110 shadow-lg"
          >
            <ChevronLeft className="w-6 h-6" />
          </button>
          <button
            onClick={scrollRight}
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 p-3 rounded-full glass hover:scale-110 shadow-lg"
          >
          ...
          <div
            ...
            className="flex gap-8 overflow-x-auto scrollbar-hide pb-4 px-12 overflow-y-hidden"
          >
            ...
            >
              <div className="apple-card h-full">
                <div className="relative h-56 overflow-hidden rounded-t-3xl">
                  ...
                  <div
                    className={`absolute inset-0 bg-gradient-to-t ${projects[currentIndex]?.gradient} opacity-20`}
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" />
                </div>
                <div className="p-6">
