            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              {[
                ...
                >
                  ...
                  <p className="text-slate-600 dark:text-slate-300">{item.info}</p>
                </motion.div>
              ))}
            </div>
            ...
            <div className="flex justify-center items-center gap-4 mb-12">
              {socialLinks.map((link, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className={`p-4 rounded-full glass text-slate-600 dark:text-slate-300 smooth-transition ${link.color} ${link.bgColor} shadow-lg hover:shadow-xl`}
                >
                  {link.icon}
